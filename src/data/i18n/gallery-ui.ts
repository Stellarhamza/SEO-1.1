...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	en: {
		...
		title: 'tarkov cheats gallery',
		subtitle: 'Simple tarkov cheats visuals — ESP, wallhack, aimbot, and radar for Escape from Tarkov on PC.',
		lead: 'Tarkov Cheats helps you spot PMCs, Scavs, loot, and extracts with ESP, aimbot, and radar in one license.',
		highlights: [
			{ title: 'tarkov cheats esp', copy: 'See players through walls with tarkov cheats esp and wallhack overlays.' },
			{ title: 'tarkov cheats radar', copy: 'Track nearby threats with tarkov cheats radar before you push or extract.' },
			{ title: 'tarkov cheats aimbot', copy: 'Use soft aim and aimbot controls tuned for Tarkov raids on Windows PC.' },
		],
	...
	es: {
		...
		subtitle: 'Visuales de Escape from Tarkov con loadouts, peleas de escuadrón y combate battle royale — junto a herramientas ESP, radar y Aimbot.',
	...
	fr: {
		...
		subtitle: 'Visuels Escape from Tarkov — loadouts, combats d\'escouade et battle royale — avec ESP, radar et Aimbot.',
	...
	de: {
		...
		lead: 'Tarkov Cheats passt zur BR-Schleife von Escape from Tarkov: Karte lesen, Gegner-Trupps tracken, looten und Reboot van überleben.',
		highlights: [
	...
	pt: {
		...
		subtitle: 'Visuais de Escape from Tarkov com loadouts, combates de esquadrão e battle royale — com ESP, radar e Aimbot.',
	...
	it: {
		...
		subtitle: 'Immagini Escape from Tarkov — loadout, scontri di squadra e battle royale — con ESP, radar e Aimbot.',
	...
	nl: {
		...
		subtitle: 'Escape from Tarkov-beelden van loadouts, squadgevechten en battle royale — met ESP, radar en Aimbot.',
		lead: 'Tarkov Cheats volgt de BR-loop van Escape from Tarkov: kaart lezen, vijandelijke squads volgen, looten en de extract overleven.',
		highlights: [
	...
	pl: {
		eyebrow: 'Tarkov Cheats',
		title: 'Galeria Escape from Tarkov',
		subtitle: 'Grafiki Escape from Tarkov — loadouty, walki drużynowe i battle royale — z ESP, radar i Aimbot.',
	...
	ru: {
		...
		subtitle: 'Визуалы Escape from Tarkov — лоадауты, бои отрядов и battle royale — с ESP, радаром и Aimbot.',
		lead: 'Tarkov Cheats создан для BR-цикла Escape from Tarkov: читать карту, отслеживать вражеские отряды, лут и выживать в extract.',
		highlights: [
	...
	ar: {
		...
		subtitle: 'صور Escape from Tarkov — loadouts ومعارك الفرق وbattle royale — مع ESP ورادار وAimbot.',
	...
	id: {
		...
		subtitle: 'Visual Escape from Tarkov — loadout, pertempuran squad, dan battle royale — dengan ESP, radar, dan Aimbot.',
	...
	th: {
		...
		subtitle: 'ภาพ Escape from Tarkov — loadout การต่อสู้ทีม และ battle royale — พร้อม ESP เรดาร์และ Aimbot',
	...
	vi: {
		...
		subtitle: 'Hình ảnh Escape from Tarkov — loadout, chiến đấu squad và battle royale — với ESP, radar và Aimbot.',
	...
	uk: {
		eyebrow: 'Tarkov Cheats',
		title: 'Галерея Escape from Tarkov',
		subtitle: 'Візуали Escape from Tarkov — loadout, бої загонів і battle royale — з ESP, радаром і Aimbot.',
		lead: 'Tarkov Cheats для BR-циклу Escape from Tarkov: читати карту, відстежувати ворожі загони, лут і виживати в extract.',
		highlights: [
	...
	cs: {
		eyebrow: 'Tarkov Cheats',
		title: 'Galerie Escape from Tarkov',
		subtitle: 'Escape from Tarkov vizuály — loadouty, squad souboje a battle royale — s ESP, radarem a Aimbot.',
	...
	ro: {
		eyebrow: 'Tarkov Cheats',
		title: 'Galerie Escape from Tarkov',
		subtitle: 'Vizualuri Escape from Tarkov — loadout, lupte de squad și battle royale — cu ESP, radar și Aimbot.',
	...
	sv: {
		...
		subtitle: 'Escape from Tarkov-bilder — loadouts, squadstrider och battle royale — med ESP, radar och Aimbot.',
		lead: 'Tarkov Cheats för Escape from Tarkov:s BR-loop: läs kartan, spåra fiendesquads, loota och överlev extract.',
		highlights: [
