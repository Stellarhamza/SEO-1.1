...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Tarkov Cheats feels smooth on Customs. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in Tarkov Cheats feels smooth on Customs.',
	...
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on Scav runs. You can see who is holding a hallway before you push. Still worth the price for Tarkov Cheats.',
		short: 'ESP boxes help on Scav runs. Still worth the price for Tarkov Cheats.',
		slug: 'tarkov-esp-scav-run-review-buildsr4k',
		seoTitle: 'ESP Review by @buildsR4K — 4/5 | {brand}',
		seoDescription: '@buildsR4K rates {brand} ESP 4/5 for Scav runs on Windows PC.',
		date: '2026-07-19',
		tag: 'Scav run',
	}),
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Tarkov Cheats this wipe. Setup was simple. It stayed up after the last BattlEye update when my old cheat failed. Lifetime was a good buy.',
		short: 'Tarkov Cheats stayed up after the last BattlEye update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Tarkov Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Tarkov Cheats pays for the monthly plan. Extract markers and distance make early raids faster.',
		short: 'Loot ESP in Tarkov Cheats pays for the monthly plan.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Tarkov Cheats since last wipe. Soft aim per weapon helps in dorms. Status updates after BattlEye patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Tarkov Cheats helps in dorms.',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Tarkov Cheats saved me near extracts. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Tarkov Cheats saved me near extracts.',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Tarkov Cheats posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Tarkov Cheats was back the next morning after a patch.',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Tarkov Cheats is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Tarkov Cheats is excellent.',
