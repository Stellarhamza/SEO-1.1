...
function buildLegal(locale, pageKey, kind) {
	...
	return {
		...
		h1,
		intro: p.s1(`${h1} for besttarkovcheats.com and Escape from Tarkov licenses.`),
		imageAlt: 'tarkov cheats',
		galleryTitle: 'tarkov cheats',
		heroImage: HERO_IMAGES[pageKey],
		...
		sections: [
			section(
				...
				kind === 'privacy' ? 'Payment details are processed by Zadeyo checkout — not stored on besttarkovcheats.com.' : p.s2(),
			),
			section(
